...
%CALCUL_CORRECTEUR_PI
%   Calcul de la suite pour le correcteur PI
    wu = omega_u;
    wi = omega_i;
    F = Frequence; 
    p = tf('s');
    ...
    % Récupération du numérateur de la transmittance en Z du correcteur PI
    num=C_discret.num{1}; 
    % Récupération du dénominateur de la transmittance en Z du correcteur PI
    den=C_discret.den{1}; 
